...
var propsHandler = exports.propsHandler = function propsHandler(elementProps, element) {
  null != elementProps && (0, _.attributeHandler)(elementProps, element), (0, _.eventHandler)(elementProps, element);
};
},{"./":"../dist/src/core/dom/element/props/index.js"}],"../dist/src/core/reactivity/createComputation.js":[function(require,module,exports) {
"use strict";
...
var currentComputation = exports.currentComputation = null,
  createComputation = exports.createComputation = function createComputation(computation) {
    exports.currentComputation = currentComputation = computation, computation(), exports.currentComputation = currentComputation = null;
  };
...
},{"buffer":"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"../dist/src/core/reactivity/createSignal.js":[function(require,module,exports) {
"use strict";
...
},{"./createComputation.js":"../dist/src/core/reactivity/createComputation.js","lodash":"../node_modules/lodash/lodash.js"}],"../dist/src/core/reactivity/createEffect.js":[function(require,module,exports) {
"use strict";
...
},{"./signalHandler":"../dist/src/core/dom/signal/signalHandler.js"}],"../dist/src/core/dom/element/props/attributeHandler.js":[function(require,module,exports) {
"use strict";
...
var attributeHandler = exports.attributeHandler = function attributeHandler(elementProps, element) {
  for (var attribute in elementProps) null == attribute || "children" === attribute || attribute.startsWith("on") || ("style" === attribute ? (0, _reactivity.createEffect)(function () {
    return (0, _.styleHandler)(elementProps, element);
  }) : element.setAttribute(attribute, elementProps[attribute]));
};
},{"./":"../dist/src/core/dom/element/props/index.js","../../../reactivity":"../dist/src/core/reactivity/index.js","../../signal":"../dist/src/core/dom/signal/index.js"}],"../dist/src/core/dom/event/createEvent.js":[function(require,module,exports) {
"use strict";
...
},{"../../event":"../dist/src/core/dom/event/index.js"}],"../dist/src/core/dom/element/props/styleHandler.js":[function(require,module,exports) {
"use strict";
...
var styleHandler = exports.styleHandler = function styleHandler(elementProps, element) {
  ...
  "string" == typeof elemStyle ? elemStyle.cssText = elemePropStyle : Object.assign(elemStyle, elemePropStyle);
};
},{"../../../reactivity":"../dist/src/core/reactivity/index.js"}],"../dist/src/core/dom/element/props/index.js":[function(require,module,exports) {
"use strict";
...
var processNestedChildren = exports.processNestedChildren = function processNestedChildren(child, fragment) {
  child.forEach(function (child) {
    ...
    null != child && (child instanceof Node && (childToAppend = child), childToAppend && fragment.appendChild(childToAppend));
  });
};
},{"../../../reactivity":"../dist/src/core/reactivity/index.js"}],"../dist/src/core/dom/element/childrens/processChildren.js":[function(require,module,exports) {
"use strict";
...
},{"../../signal/":"../dist/src/core/dom/signal/index.js","../../../reactivity/":"../dist/src/core/reactivity/index.js","./processNestedChildren.js":"../dist/src/core/dom/element/childrens/processNestedChildren.js"}],"../dist/src/core/dom/element/childrens/index.js":[function(require,module,exports) {
"use strict";
...
},{"./dom":"../dist/src/core/dom/index.js","./dynamicStyle":"../dist/src/core/dynamicStyle/index.js","./reactivity":"../dist/src/core/reactivity/index.js"}],"../dist/src/test/App.js":[function(require,module,exports) {
"use strict";
...
var nestedData = [{
  ...
  getStyle = function getStyle(level) {
    return {
  ...
  renderNestedLevels = function renderNestedLevels(data) {
    return data.map(function (levelData) {
      return _core.olka.createElement("div", {
        key: levelData.level,
        className: "level-".concat(levelData.level),
        style: getStyle(levelData.level)
      }, _core.olka.createElement("p", {
        style: headerStyle
      }, "This is level ".concat(levelData.level)), _core.olka.createElement("ul", null, levelData.items.map(function (item, index) {
        return _core.olka.createElement("li", {
          key: index,
          style: listStyle
        }, item);
      })), _core.olka.createElement("img", {
        src: levelData.img,
        alt: "Level ".concat(levelData.level),
        style: imageStyle
      }), _core.olka.createElement("button", {
        style: buttonStyle
      }, "Click me"), _core.olka.createElement("input", {
        type: "text",
        placeholder: "Input at level ".concat(levelData.level),
        style: inputStyle
      }), levelData.nested && renderNestedLevels(levelData.nested));
    });
  },
  NestedLevels = function NestedLevels() {
    return _core.olka.createElement("div", {
      id: "root"
    }, renderNestedLevels(nestedData));
  };
var _default = exports.default = function _default() {
  return _core.olka.createElement(NestedLevels, null);
};
