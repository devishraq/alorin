...
var createElement = exports.createElement = function createElement(tag, props) {
  ...
  return "function" == typeof tag ? element = tag.apply(void 0, [props].concat(childrens)) : (element = document.createElement(tag), null !== props && (console.log(props), Object.assign(element.style, props.style))), childrens.forEach(function (node) {
    "string" == typeof node ? (childNode = document.createTextNode(node), fragment.appendChild(childNode)) : fragment.appendChild(node);
...
var _default = exports.default = function _default() {
  return _core.olka.createElement("h1", null, "My Title");
};
...
require("./SubTitle");
var _default = exports.default = function _default() {
  return _core.olka.createElement("h1", {
